...
def generate_random_records(num_records=1000000):
    ...
    for _ in range(num_records):
        ...
        # Random district (if available for the state)
        district = random.choice(districts.get(state, ['Unknown']))
        
        # Random crop year between 2010 and 2023
        crop_year = random.randint(2010, 2023)
        ...
        # Random area (between 1 and 10000 hectares)
        area = round(random.uniform(1, 10000), 2)
        
        # Random production (between 1 and 100000 tons)
        production = round(random.uniform(1, 100000), 2)
        
        # Add to data dictionary
        data['State_Name'].append(state)
        data['District_Name'].append(district)
        data['Crop_Year'].append(crop_year)
        data['Season'].append(season)
        data['Crop'].append(crop)
        data['Area'].append(area)
        data['Production'].append(production)
    ...
    print(f"Generated {num_records} random records and saved to 'agricultural_data.csv'")
